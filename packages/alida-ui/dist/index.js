...
function useRender(Component3, props, ref, { latestValues }, isStatic, forwardMotionProps = false) {
  ...
  const elementProps = Component3 !== import_react16.Fragment ? __spreadProps(__spreadValues(__spreadValues({}, filteredProps), visualProps), { ref }) : {};
  const { children } = props;
  const renderedChildren = (0, import_react16.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
  return (0, import_react16.createElement)(Component3, __spreadProps(__spreadValues({}, elementProps), {
...
function useVisualElement(Component3, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react20.useRef)(Boolean(optimisedAppearId) && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
    if (!visualElement)
      return;
...
function createMotionComponent(Component3, { forwardMotionProps = false } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    let MeasureLayout2;
    const configAndProps = __spreadProps(__spreadValues(__spreadValues({}, (0, import_react21.useContext)(MotionConfigContext)), props), {
    ...
    return (0, import_jsx_runtime4.jsxs)(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? (0, import_jsx_runtime4.jsx)(MeasureLayout2, __spreadValues({ visualElement: context.visualElement }, configAndProps)) : null, useRender(Component3, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, forwardMotionProps)] });
  }
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(MeasureLayoutWithContext, __spreadProps(__spreadValues({}, props), { layoutGroup, switchLayoutGroup: (0, import_react23.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove }));
}
...
function CardContent(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", __spreadProps(__spreadValues({ className: `p-4 text-white/90 ${className}` }, props), { children }));
}
...
var createLucideIcon = (iconName, iconNode) => {
  const Component3 = (0, import_react25.forwardRef)(
    (_a, ref) => {
      var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
      return (0, import_react25.createElement)(Icon, __spreadValues({
        ref,
        iconNode,
...
var navItems = [
  ...
  { label: "About", icon: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(User, { size: 18 }), href: "/about" },
  { label: "Github", icon: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Github, { size: 18 }), href: "https://github.com/jakobdahlin/alida-ui" }
];
var Navbar = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("header", { className: "sticky top-0 left-0 w-full flex justify-center z-50", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex w-full max-w-[1100px] flex-col items-center px-4 relative", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "relative flex w-full items-center justify-between p-2 rounded-full overflow-hidden", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("nav", { className: "hidden md:flex items-center gap-2 pr-4", children: navItems.map(({ label, icon, href }) => {
        ...
        return isExternal ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          "a",
          {
            href,
            target: "_blank",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(AnimatePresence, { children: menuOpen && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      motion.nav,
      {
...
var Footer = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("footer", { className: "w-full border-t border-white/10 bg-black text-white/70", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "max-w-[1100px] mx-auto px-6 flex flex-col md:flex-row justify-between gap-10 mt-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h2", { className: "text-white text-lg tracking-wide", children: "Alida" }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "text-sm text-white/50 max-w-sm", children: "Minimal, open-source design system for building modern interfaces with clarity and speed." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "grid grid-cols-2 gap-x-12 gap-y-2 text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "text-white font-semibold mb-1", children: "Resources" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_link2.default, { href: "/components", className: "text-white/50 hover:text-white transition", children: "Components" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_link2.default, { href: "/docs", className: "text-white/50 hover:text-white transition", children: "Docs (coming soon)" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_link2.default, { href: "/about", className: "text-white/50 hover:text-white transition", children: "About" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "text-white font-semibold mb-1", children: "For Developers" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Github, { size: 14 }),
                " GitHub Repo"
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
            "a",
            {
              ...
              className: "text-white/50 hover:text-white transition flex items-center gap-2",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(CodeXml, { size: 14 }),
                " NPM Package"
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
            "a",
            {
              ...
              className: "text-white/50 hover:text-white transition flex items-center gap-2",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Mail, { size: 14 }),
                " Contact"
              ]
            }
          )
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "flex flex-col items-start md:items-end gap-3", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "a",
          {
            href: "https://github.com/jakobdahlin/alida-ui",
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Github, { size: 20 })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "a",
          {
            href: "mailto:contact@alida.dev",
            className: "hover:text-white transition",
            children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Mail, { size: 20 })
          }
        )
      ] }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "w-full border-t border-white/10 mt-4 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-center gap-2 text-xs text-white/30 text-center px-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("p", { className: "flex items-center gap-1", children: [
        "Built with ",
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Heart, { size: 14 }),
        " and ",
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Coffee, { size: 14 }),
...
function Tabs({ tabs }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "w-full", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "flex justify-center gap-4 mb-4", children: tabs.map((tab, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
      "button",
      {
        onClick: () => setActive(i),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "text-white/80 text-center", children: tabs[active].content })
  ] });
}
